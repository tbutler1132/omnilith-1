...
export interface RelationshipRepository {
  ...
  findByUserAndOrganism(userId: UserId, organismId: OrganismId): Promise<ReadonlyArray<Relationship>>;
  findByOrganism(organismId: OrganismId, type?: RelationshipType): Promise<ReadonlyArray<Relationship>>;
  findByUser(userId: UserId, type?: RelationshipType): Promise<ReadonlyArray<Relationship>>;
}
