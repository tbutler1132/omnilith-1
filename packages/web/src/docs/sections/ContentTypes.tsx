...
const tiers = [
  { tier: 1 as const, label: 'Tier 1 — Creative Fundamentals', description: 'The minimum viable studio. Audio, text, images, spatial maps, composition references, and threads.' },
  { tier: 2 as const, label: 'Tier 2 — Governance', description: 'Required when communities grow. Policies that evaluate proposals to parent organisms.' },
  { tier: 3 as const, label: 'Tier 3 — Awareness', description: 'The cybernetic layer. Sensors, variables, and response policies composed together create feedback loops.' },
];
  ...
  return (
    <div className="docs-section">
      ...
      <p className="docs-lead">
        Every content type registers a contract: schema, validator, and optional
        evaluator. Content types are plugins — they teach the kernel how to handle
        specific kinds of data. New capabilities enter through new content types,
              ...
              {types.map((ct) => (
                <div key={ct.typeId} className="docs-card" style={{ borderTopColor: color }}>
                  <div style={{
                    ...
                    <code className="docs-code" style={{
                      background: 'var(--bg)',
                      fontSize: 12,
                      fontWeight: 600,
                    }}>{ct.typeId}</code>
                  ...
                  <table className="docs-table">
                    ...
                    <tbody>
                      {ct.fields.map((f) => (
                        <tr key={f.name}>
                          <td><code className="docs-code">{f.name}</code></td>
