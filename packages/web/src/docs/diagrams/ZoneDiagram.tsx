      ...
      <div style={{
        ...
        <div style={{
          ...
          >
            ...
            <line x1="30" y1="150" x2="57" y2="150" stroke="var(--text-dim)" strokeWidth="1.5" strokeDasharray="4 3" markerEnd="url(#arrow-in)" />
            {/* Right arrow: adapter → plugins */}
            <line x1="390" y1="150" x2="363" y2="150" stroke="var(--text-dim)" strokeWidth="1.5" strokeDasharray="4 3" markerEnd="url(#arrow-in)" />
            {/* Bottom arrow: adapter → kernel (skip plugins) */}
            <line x1="210" y1="280" x2="210" y2="253" stroke="var(--text-dim)" strokeWidth="1.5" strokeDasharray="4 3" markerEnd="url(#arrow-in)" />
          </svg>
        </div>
      </div>
