    ...
    <div className="docs-diagram" style={{ padding: '24px 0' }}>
      ...
      >
        <div style={{ fontSize: 12, color: 'var(--text-dim)', lineHeight: 1.6 }}>
          <strong style={{ color: 'var(--text)' }}>No policy children?</strong> The organism is open — state changes are
          unrestricted.
          <br />
          <strong style={{ color: 'var(--text)' }}>Open-trunk?</strong> Bypasses proposal evaluation entirely. Any
          authorized user can append state directly.
        </div>
      </div>
    </div>
  );
...
function FlowArrow() {
  return (
    <svg width="32" height="20" style={{ flexShrink: 0 }}>
      <title>Arrow</title>
      <defs>
        <marker id="flow-arrow" viewBox="0 0 10 7" refX="10" refY="3.5" markerWidth="8" markerHeight="6" orient="auto">
