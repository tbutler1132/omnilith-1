/**
 * CadenceMarkdownPreview — lightweight markdown preview for boundary cadence tabs.
 *
 * Renders heading, list, paragraph, and table blocks so cadence content can be
 * scanned quickly from the panel without exposing raw markdown syntax.
 */
...
function parseTableBlock(lines: string[]): TableBlock | null {
...
function renderMarkdownBlocks(lines: string[]): ReactNode[] {
